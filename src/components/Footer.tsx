export default function Footer() {
  return (
    <div className="bg-[#fafafa] dark:bg-[#202023]/30  md:mt-16 px-[20px] md:px-16 md:pt-16 pt-7 pb-24 md:pb-9 md:h-52 flex flex-col justify-between font-medium relative z-10 lg:-translate-y-[48px]">
      <img src="/images/gdg-logo.png" className="h-10 w-auto mr-auto" />
